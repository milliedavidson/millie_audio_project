    ...
    public partial class Synthesizer : Form
    {
        ...
        private void Synthesizer_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            using (BinaryWriter binaryWriter = new BinaryWriter(memoryStream))
            {
                ...
                // Now we have the stream of data, the SoundPlayer class can accept it
                // memoryStream has a position (like a pointer) which is why we set the position below. 0 takes us to
                // the start, to RIFF
